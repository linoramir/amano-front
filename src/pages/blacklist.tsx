...
const MAIN_MENU = [
  ...
  { label: "Lista negra", icon: Ban, active: true, to: "/lista-negra" },
];
      ...
      <div className="flex flex-1 flex-col min-w-0">
        ...
        <div className="flex-1 overflow-auto bg-[var(--bg-page)] p-6">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-[var(--text)]">Página de Lista Negra</h1>
            <p className="mt-2 text-[var(--text-muted)]">Esta es una página en blanco para lista negra</p>
          </div>
        </div>
      </div>
    </div>
