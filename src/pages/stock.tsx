...
const MI_NEGOCIO = [
  ...
  { label: "Stock", icon: PackageCheck, active: true, to: "/stock" },
      ...
      <div className="flex flex-1 flex-col min-w-0">
        ...
        <div className="flex-1 overflow-auto bg-[var(--bg-page)] p-6">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-[var(--text)]">Página de Stock</h1>
            <p className="mt-2 text-[var(--text-muted)]">Esta es una página en blanco para stock</p>
          </div>
        </div>
      </div>
    </div>
